const projectsData = [
    ...
    },
    {
        ...
        frDescription: "Un site générateur de séances de sport qui récupère les exercices de la base de données pour créer des entraînements sur mesure. Pour les administrateurs, il y a possiblité d'ajouter et de supprimer un exercice. Entièrement responsive.",
        enDescription: "I wanted to make my daily life easier and therefore create a generator of sports sessions that would create the best workouts. This generator draws exercises from a database and loads thoughtful workouts. Fully responsive.",
    ...
    },
    {
        ...
        enDescription: "A quiz that tests your flags knowledge. It boosts you to become better thanks to scores and ranking. You can challenge your friends in specific categories: Europe, Africa, Asia, Oceania, Americas. Or in the World category for the bravest (250 countries!). Fully responsive.",
