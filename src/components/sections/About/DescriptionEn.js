...
const DescriptionEn = () => {
    return (
        <AboutDescription>
            ...
            <br></br>
            <br></br>
            This new path links my needs for <DescriptionSpan>creativity</DescriptionSpan> and <DescriptionSpan>logical reasoning</DescriptionSpan>. I always push my learnings further and never give up. Well, in short, i'm having a lot of fun.
