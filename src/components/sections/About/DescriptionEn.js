...
const DescriptionEn = () => {
    return (
        <AboutDescription>
            ...
            And just like that, late Novembre 2020 I started learning Python. I guess I liked it because I never stopped since then, oops. Specializing myself in the <DescriptionSpan>MERN stack</DescriptionSpan> (MongoDB, Express, React, Node.js).
            <br></br>
            <br></br>
